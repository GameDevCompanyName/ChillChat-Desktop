...
public class Activity extends StackPane {
    ...
    public void fadeIn(){
        ...
        fadeIn.getKeyFrames().add(new KeyFrame(Duration.seconds(0.0), new KeyValue(this.scaleXProperty(), 0.01)));
        fadeIn.getKeyFrames().add(new KeyFrame(Duration.seconds(0.0), new KeyValue(this.scaleYProperty(), 0.01)));
        fadeIn.getKeyFrames().add(new KeyFrame(Duration.seconds(ACTIVITY_CHANGE_TIME), new KeyValue(this.scaleXProperty(), 1.0)));
        fadeIn.getKeyFrames().add(new KeyFrame(Duration.seconds(ACTIVITY_CHANGE_TIME), new KeyValue(this.scaleYProperty(), 1.0)));
    ...
    public void fadeOut(){
        ...
        fadeIn.getKeyFrames().add(new KeyFrame(Duration.seconds(0.0), new KeyValue(this.scaleXProperty(), 1.0)));
        fadeIn.getKeyFrames().add(new KeyFrame(Duration.seconds(0.0), new KeyValue(this.scaleYProperty(), 1.0)));
        fadeIn.getKeyFrames().add(new KeyFrame(Duration.seconds(ACTIVITY_CHANGE_TIME), new KeyValue(this.scaleXProperty(), 0.01)));
        fadeIn.getKeyFrames().add(new KeyFrame(Duration.seconds(ACTIVITY_CHANGE_TIME), new KeyValue(this.scaleYProperty(), 0.01)));
